...
SYSTEM = (
    ...
    "The ONLY dynamic variables that exist are {{name}}, {{context}} and {{phone}}. "
    "NEVER invent other placeholders (no {{CALL_TIME}}, {{date}}, {{company}} etc.) — "
    "write any other detail as literal text, because an undefined variable makes the "
    "call fail instantly. "
