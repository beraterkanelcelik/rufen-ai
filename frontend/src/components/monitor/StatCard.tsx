...
export function StatCard({
  ...
  return (
    <div
      className={`rounded-[8px] border bg-[#121212] px-4 py-3.5 transition-colors ${
        live
          ? "border-[#F97316]/50 shadow-[0_0_24px_-12px_rgba(249,115,22,0.7)]"
          : "border-[#212121]"
      }`}
    >
      ...
      {hint != null && (
        <div className="mt-1 text-[11px] text-[#8a8a8a]">{hint}</div>
      )}
    </div>
  );
}
