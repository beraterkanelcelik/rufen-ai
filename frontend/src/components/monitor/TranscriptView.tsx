    ...
    <div className="max-h-72 space-y-2.5 overflow-y-auto pr-1">
          ...
          >
            <div
              className={`max-w-[78%] rounded-2xl px-3.5 py-2 text-sm leading-snug ${
                isAgent
                  ? "rounded-tl-sm bg-[#F97316]/12 text-[#f5d4bb] ring-1 ring-[#F97316]/25"
                  : "rounded-tr-sm bg-white/5 text-[#e0e0e0] ring-1 ring-[#212121]"
              }`}
            >
              <div
                className={`mb-0.5 text-[10px] font-medium uppercase tracking-wide ${
                  isAgent ? "text-[#F97316]" : "text-[#8a8a8a]"
                }`}
              >
      ...
      {active && (
        <div className="flex justify-start">
          <div className="flex items-center gap-1 rounded-2xl rounded-tl-sm bg-[#F97316]/12 px-3.5 py-2.5 ring-1 ring-[#F97316]/25">
            <Dot delay="0s" />
            <Dot delay="0.2s" />
            <Dot delay="0.4s" />
          </div>
...
function Dot({ delay }: { delay: string }) {
  return (
    <span
      className="rufen-dot inline-block h-1.5 w-1.5 rounded-full bg-[#F97316]"
